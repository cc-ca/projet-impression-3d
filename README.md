...
The web-based dashboard (`http://<ip_raspberry>/index`) displays useful information.
...
2. **LED and Button Wiring**:
    ...
    - **Resistors**: Use 220 Ohm resistors for each connection to the RGB LED and the button to the ground
